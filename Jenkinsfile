            ...
            steps {
                script {
                    ...
                    withSonarQubeEnv() {
                        ...
                        bat "dotnet ${scannerHome}\\SonarScanner.MSBuild.dll begin /k:\"evandrolucas60_APICatalog_d53fc9b9-89b8-4ea7-944e-ae66c349b1a2\" /d:sonar.sources=\"APICatalog\" /d:sonar.exclusions=\"**/appsettings.Development.json, **/appsettings.json\""
